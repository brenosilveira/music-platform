...
export class ApiService implements IApiService {
  ...
  getTopArtists(limit: number = 10) {
    ...
    return this.httpClient.get<TopArtist>(URL)
  }
  ...
  searchByTrack(title: string, limit: number = 10) {
    ...
    return this.httpClient.get<SearchResponse<TrackResponse>>(URL)
  }
  ...
  searchByAlbum(title: string, limit: number = 10) {
    ...
    return this.httpClient.get<SearchResponse<AlbumResponse>>(URL)
  }
  ...
  searchByArtist(title: string, limit: number = 10) {
    ...
    return this.httpClient.get<SearchResponse<ArtistResponse>>(URL)
  }
}
